...
class DBManager:
    ...
    def get_companies_and_vacancies_count(self):
        ...
        with self.conn:
            with self.conn.cursor() as cursor:
                cursor.execute(
                    'SELECT employer_name, COUNT(vacancy_name) FROM vacancies JOIN employer '
    ...
    def get_all_vacancies(self):
        ...
        with self.conn:
            with self.conn.cursor() as cursor:
                cursor.execute(
                    'SELECT employer_name, vacancy_name, salary_from, salary_to, url FROM vacancies  '
    ...
    def get_avg_salary(self):
        ...
        with self.conn:
            with self.conn.cursor() as cursor:
                cursor.execute(
                    'SELECT vacancy_name, AVG(salary_from) FROM vacancies GROUP BY vacancy_name')
                data = cursor.fetchall()
                print(data)
